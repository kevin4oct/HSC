...
import com.hbth.hsc.BuildConfig;
import com.hbth.hsc.HSCApplication;
...
public class Api {
    ...
    private Api(int type) {
        //缓存
        File cacheFile = new File(HSCApplication.getContext().getCacheDir(), "cache");
...
//                if (!NetWorkUtil.isNetConnected(HSCApplication.getContext())) {
...
//                .addInterceptor(headerInterceptor)
    ...
    public static String getCacheControl() {
        return NetWorkUtil.isNetConnected(HSCApplication.getContext()) ? CACHE_CONTROL_AGE : CACHE_CONTROL_CACHE;
    }
