...
public class PaperListFragment
    ...
    public static final String TAG = PaperListFragment.class.getName();
    ...
    public void itemClicked(int viewId, int position, Object bean) {
        switch (viewId) {
            case R.id.recycler_class_resourcelist:
