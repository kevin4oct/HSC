package com.hbth.hsc.widget.video;
...
public class CustomMediacontrol extends FrameLayout
        implements Handler.Callback, CompoundButton.OnCheckedChangeListener,
...
//        mBack.setOnClickListener(this);
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        LogUtils.loge("Changed:" + newConfig.orientation);
